...
\begin{figure}
    \centering
    \includegraphics[trim=0 0.4cm 0 0.4cm, width=1\linewidth]{TimedCoverage.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[trim=1cm 0.5cm 1cm 1cm, clip, width=1\linewidth]{cvsvcomparison.pdf}

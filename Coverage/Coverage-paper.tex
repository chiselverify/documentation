...
\end{lstlisting}
In the above code snippet, we registered two \texttt{CoverGroups}, one that ensures that all of the possible operations were tested after a reset and another that ensures that the edge cases of all operations were tested.

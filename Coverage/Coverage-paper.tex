...
Therefore, if one wants to gather test coverage on a current Chisel design, one needs to rely on basic Scala software coverage tools (which we explore in more detail in a later section). 

...
In this paper, we have described the lack of coverage-oriented verification tools 
for Chisel designs and shown that existing Scala tools do not provide satisfactory results. To 
address this, we have implemented extensions to the Treadle simulator and the ChiselTest framework 
to enable statement and functional coverage measurements. Finally, we have shown that implemented 
framework enables less verbose and more advanced verification suites than possible in SystemVerilog.

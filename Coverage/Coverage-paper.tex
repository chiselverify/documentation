...
and several methods for gathering functional coverage utilizing the functional nature of Scala. We evaluate our approach with an industrial use case and compare it to existing coverage solutions from SystemVerilog.

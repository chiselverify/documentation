...
\begin{figure}
    \centering
    \includegraphics[trim=0 0.4cm 0 0.4cm, width=.7\linewidth]{TimedCoverage.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[trim=1cm 0.5cm 1cm 1cm, clip, width=0.75\linewidth]{cvsvcomparison.pdf}

...
\titlerunning{Multi-Level Code Coverage in Chisel}
...
\keywords{Hardware Verification \and Code Coverage \and Chisel \and Scala \and SystemVerilog \and FIRRTL \and Treadle}
\end{abstract}
%
%
%
...
Running the test and coverage report will create a set of HTML files. The page may optionally include the original source files with statements that were executed during the test marked in green. The global coverage results are also printed to \textt{stdout}.
%in the terminal:
%\begin{verbatim}

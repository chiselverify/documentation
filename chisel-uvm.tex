...
hardware construction language and uses Scala to drive the verification. It also explores the testing strategy used in the Universal Verification Methodology, UVM. \kasper{I feel that we should also mention UVM somewhere / why we're interested in exploring what if offers (because it's the industry "standard"?)?}
\end{abstract}
...
Recent advances with SystemVerilog and Chisel have brought object-oriented programming

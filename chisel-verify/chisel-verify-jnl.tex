...
\author{\IEEEauthorblockN{Andrew Dobis\IEEEauthorrefmark{1}, Hans Jakob Damsgaard\IEEEauthorrefmark{1}, Kevin Laeufer\IEEEauthorrefmark{2},\\
Tjark Petersen\IEEEauthorrefmark{1}, Kasper Juul Hesse Rasmussen\IEEEauthorrefmark{1}, Enrico Tolotto\IEEEauthorrefmark{1},\\
Simon Thye Andersen\IEEEauthorrefmark{1}, Richard Lin\IEEEauthorrefmark{2}, Martin Schoeberl\IEEEauthorrefmark{1}}\\
...
\textit{UC Berkeley}\\
Berkeley, CA \\\\
andrew.dobis@inf.ethz.ch, hans.damsgaard@tuni.fi, laeufer@berkeley.edu, s186083@student.dtu.dk, \\
...
%\martin{Maybe we should already reference our WOSET paper here as well: \cite{verify:fuzzing:2021}} Andrew:  Mentioned in the coverage section.

...
methods to support the both formal and dynamic verification of digital designs in Scala.
...
and transaction-level modelling in a verification library named ChiselVerify, while the formal
...
Next, we describe our solution for enabling verification in Chisel, called ChiselVerify, in section~\ref{sec:verify}.
Section~\ref{sec:formal} presents an orthogonal approach to classic test driven verification by using formal
methods for verification. 
Finally, Section~\ref{sec:eval} evaluates ChiselVerify with three use cases, and section~\ref{sec:conclude} concludes the paper.
...
\begin{figure}[h]
  ...
  Thus, while it can be more concise to declare coverpoints in cocotb with simple designs, complex relations, often found in realistic designs, are far more difficult to model.
...
\begin{IEEEbiography}[{\includegraphics[trim={3cm 0 3cm 0}, width=1in,height=1.25in,clip,keepaspectratio]{bios/dobis.jpg}}]{Andrew Dobis}
...
\begin{IEEEbiography}[{\includegraphics[trim={1cm 0 1cm 0}, width=1in,height=1.25in,clip,keepaspectratio]{bios/kevin.jpg}}]{Kevin Laeufer}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bios/Hans.jpg}}]{Hans Jakob Damsgaard}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bios/tjark.jpg}}]{Tjark Petersen}
...
\begin{IEEEbiography}[{\includegraphics[trim={2.5cm 0 2.5cm 0}, width=1in,height=1.25in,clip,keepaspectratio]{bios/kasper.jpg}}]{Kasper Hesse}
...
\begin{IEEEbiography}[{\includegraphics[trim={2.5cm 0 2.5cm 0}, width=1in,height=1.25in,clip,keepaspectratio]{bios/enrico.jpg}}]{Enrico Tolotto}
...
\begin{IEEEbiography}[{\includegraphics[trim={1cm 0 1cm 0},width=1in,height=1.25in,clip,keepaspectratio]{bios/simon.jpg}}]{Simon Thye Andersen}
  ...
  He now currently works at Teledyne RESON as Firmware and Hardware engineer.
\end{IEEEbiography}

\begin{IEEEbiography}{Richard Lin}%[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bios/tjark.jpg}}]{Kasper Hesse}
  obtained a PhD in Computer Science from UC Berkeley in 2019.
  His research focuses on open-source electronics design tools, and he is a major contributor to Chisel.
  More specifically, he is one of the main contributors to the ChiselTest testing framework.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{bios/martin_small.jpg}}]{Martin Schoeberl}
  is an Associate Professor at the Technical University of Denmark (DTU), and has been since 2010.
  Before that, he was an Assistant Professor at the Institute of Computer Engineering at TU Vienna, where he obtained his PhD in 2005.
  His research interest are mainly in Time-Predictable computer architecture, Real-Time systems, and more recently hardware verification.

...
\author{\IEEEauthorblockN{Order TBD before submission \hjd{(Kevin should be ahead of me here...)}, Andrew Dobis\IEEEauthorrefmark{1}, Tjark Petersen\IEEEauthorrefmark{1}, Hans Jakob Damsgaard\IEEEauthorrefmark{1},\\
...
\textit{UC Berkeley}\\
Berkeley, CA \\\\
andrew.dobis@inf.ethz.ch, s186083@student.dtu.dk, hans.damsgaard@tuni.fi, laeufer@berkeley.edu, s183735@student.dtu.dk, \\
...
The main interface is the \texttt{register} method, which stores \texttt{cover} construct to \texttt{bin} mappings inside of a \texttt{CoverageDB} database object.

...
Finally, we evaluate our solution by directly comparing the runtime of two tests, one implemented using SystemVerilog with UVM and the other with ChiselVerify. 
...
\textbf{UVM}             & 0.4           & 0.16                   & 82.5                  \\ \hline
\textbf{ChiselVerify}    & x             & y                      & 13.23                 \\ \hline
\end{tabular}

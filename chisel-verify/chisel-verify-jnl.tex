...
\subsection{Formal Verification of an RTL Memory}
...
The example shown in Figure~\ref{fix:quiz15} verifies that when a Chisel memory with synchronous read port and

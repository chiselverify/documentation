...
implementing a custom CSP solver in Scala based on backtracing and arc consistency, as described in~
\cite{russell2002artificial}, performed poorly. Instead, ChiselVerify provides a wrapper to an existing CSP solver and 
a domain-specific language, which allows users to declare and randomize objects. \hjd{We need a reference to the CSP 
solver now.}

...
\hjd{Maybe the transition between paragraphs could be smoother here.} With agile hardware design already being enabled through the Chisel, we focus our attention on the verification flow.
This paper proposes ChiselVerify, an open-source library for verifying %hardware construction language and uses Scala to drive the verification process.
...
This section presents a brief overview of hardware verification and Chisel as a hardware construction language.

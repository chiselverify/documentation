...
\todo{Andrew: DONE, I explained the concepts as I introduced them, and made sure to always use the same terms throughout the paper.}
...
\reply{This was removed. as it does not add any additional information to the description of the coverage tool.}

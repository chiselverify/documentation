...
With ChiselTest we can co-simulate with Java and Scala models and using the Java Native Interface
...
Digital design described in Chisel can be tested and verified with
ChiselTest~\cite{chisel:tester2}, a non-synthesizable testing framework for Chisel.
ChiselTest emphasizes on usability and simplicity while providing ways to scale up complexity.
...
hardware generators. A hardware generator is a program that can generate configurable
hardware description.
Scala with functional programming is a good basis to develop a methodology for the
...
%
Within our verification frame work we will support mixed language verification.
...
We plan the open-source Yosys synthesis suite~\cite{Yosys} with the GHDL~\cite{ghdl}
to translate VHDL into Verilog.
...
Several companies are interested in the SDH project and support it with non-trivial use cases.
Teledyne is interested in exploring Chisel for development and testing with compatibility of VHDL and Verilog.
Microchip is interested in using Chisel to improve the design throughput and will
provide a hardware use case to sort Ethernet packets according to their deadlines.
Synopsys provides tool support for the project.
WSA provides a decimation filter use case for our verification framework.
Napatech will follow the project and provide challenges for the project.
...
{\small
  \begin{center}
    \begin{tabular}{lccp{110mm}l}
      ...
      Property & 6   & PhD2      & Develop property-based testing the specifications with ScalaCheck.                                                      \\
...
\ganttbar[name=t5]{Perpare1}{7}{9} \\
\ganttbar[name=t6]{Spec}{10}{15} \\
\ganttbar[name=t7]{Property}{16}{21} \\

...
Functional verification is one of the main tasks in hardware development. Its goal is to validate the design specifications against the hardware model. Traditionally, the functional verification of new designs consumes more than half of the development time of an integrated circuit. Give the current tendency of adopting a more agile development workflow for hardware design \cite{Groleat2020Jan}, past verification techniques are no longer enough. A possible approach for reducing the time of functional verification, is to use random verification. Random verification is a validation technique that is composed of two main components, Constrained Randomization and Functional Coverage.

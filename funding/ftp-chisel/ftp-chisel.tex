...
{\bf\color{red}introduce methods inspired by software development and testing into the realm of digital design.}
...
{\color{red}We will take inspiration from software development tools, languages, and testing methods
...
We will develop property-based testing by {\color{red}adopting ScalaCheck as a starting point for test generation}, and adding
temporal assertions to the {\color{red}device under testing}.
...
Properties of interest can guide random test generation {\color{red}toward producing a reduced number of randomized tests, while still covering a hardware design adequately.}
{\color{red}%

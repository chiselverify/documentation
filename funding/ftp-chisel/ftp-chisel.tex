...
Many implementation are based on the seminal paper \cite{DBLP:conf/icfp/ClaessenH00}, including, e.g., ScalaCheck~\cite{ScalaCheck}.
...
Frist steps towards the verification framework \emph{ChiselVerify} are described in~\cite{ChiselVerify:2021}.
...
{\small
  \begin{center}
    \begin{tabular}{lccp{110mm}l}
      ...
      TypeSys                &    2   &  AS  & Develop a stronger type system for Chisel towards Chisel 4. \\
...
We aim to increase the productivity by a factor of two. Measuring productivity directly

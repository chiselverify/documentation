...
In response to the shortage, the European Chip Act aims to strengthen
Europe's resilience and competitiveness in semiconductor technologies and applications.
Furthermore, the greater Copenhagen area has many innovative chip design companies.
The companies expect a need of about 20 chip design engineers per year.
...
The aim of this project is to support the Danish chip design industry by {\bf increasing
...
transition.
%
Following {\bf companies are interested in the SDH project} and support it with use cases.
...
student for 6 months at the University of Sussex. During this time they will explore the design and

...
I'm currently working full time for Huawei's Cambridge Research Center
processor verification.

I am also the officiaL RISC-V "golden Sail model" maintainer.

I am also a senior lecturer in Informatics at the University of Sussex,
currently on a sabbatical, where I successfully supervised 3 PhD
students, and I'm currently supervising 2 more.  My background is in
programming languages, compilers and typing systems for parallel
computation, as well as verification of programs. I have extensive
teaching experience in various subjects, including networking, operating
systems, compilers and software engineering.  Before joining the
University of Sussex I was a postdoc at Imperial College and Queen Mary,
University of London. I received a PhD in computing from Imperial
College, an undergraduate degree (Diplom Informatiker) from Technical
University Berlin.

My publications can be found at

   https://martinfriedrichberger.net/
   https://scholar.google.co.uk/citations?user=GCz-DJ0AAAAJ
...
\martin{write on: productivity increase by a factor of 2. But hard to measure, we will compare
the LoC between UVM and ChiselVerify and it should be 1/3.}

...
\begin{itemize}
\item Should be bigger than just hardware verification, maybe HW/SW co-verification
\item Translate hardware to model checking model
\end{itemize}

To discuss:

\begin{itemize}
\item Martin: maybe we should use a more interesting example, e.g., an arbiter with a verification plan (see beolw)
\end{itemize}
...
{\bf Martin Schoeberl (MS)} is professor at DTU Compute.
